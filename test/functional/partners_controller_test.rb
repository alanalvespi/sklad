...
class PartnersControllerTest < ActionController::TestCase
  ...
  test "should create partner" do
    assert_difference('Partner.count') do
      post :create, partner: { email: @partner.email, id_partner: @partner.id_partner, partner_name: @partner.partner_name, telephone: @partner.telephone }
    end
  ...
  test "should update partner" do
    put :update, id: @partner, partner: { email: @partner.email, id_partner: @partner.id_partner, partner_name: @partner.partner_name, telephone: @partner.telephone }
    assert_redirected_to partner_path(assigns(:partner))
  end
